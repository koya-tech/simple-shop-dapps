...
import { Home, Search, ShoppingCart, Heart, User, Facebook, Twitter, Instagram, Youtube } from 'lucide-react';
        ...
        <nav className="flex justify-between items-center px-4 py-2">
          {navItems.map(({ icon: Icon, label, active }) => (
            ...
            >
              <Icon 
                size={24} 
                className={active ? 'text-cs-green' : 'text-cs-darkgrey'} 
              />
              <span 
                className={`text-xs ${
                  active ? 'text-cs-green font-medium' : 'text-cs-darkgrey'
                }`}
              >
                {label}
              </span>
          ...
          <div className="grid grid-cols-4 gap-8 mb-12">
            ...
            <div>
              <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-xl font-semibold">ChainShop</span>
              </div>
              <p className="text-cs-darkgrey mb-6">
                Experience premium audio quality with our carefully curated selection of audio equipment.
              </p>
